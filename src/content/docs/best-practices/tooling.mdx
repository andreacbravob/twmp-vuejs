...
export const exampleCodeyarn = `# For Yarn Modern (v2+)\n$ yarn create vue@latest\n# For Yarn ^v4.11\n$ yarn dlx create-vue@latest`;
...
:::note
We recommend using this package via the `vue/compiler-sfc` deep import since this ensures its version is in sync with the Vue runtime.
:::
