...
export const exampleCodeVueTestUtils = `const valueSelector = '[data-testid=stepper-value]'\nconst buttonSelector = '[data-testid=increment]'\n\nconst wrapper = mount(Stepper, {\n\tprops: {\n\t\tmax: 1\n\t}\n})\nexpect(wrapper.find(valueSelector).text()).toContain('0')\nawait wrapper.find(buttonSelector).trigger('click')\nexpect(wrapper.find(valueSelector).text()).toContain('1')`;
export const exampleCodeCypress = `const valueSelector = '[data-testid=stepper-value]'\nconst buttonSelector = '[data-testid=increment]'\n\nmount(Stepper, {\n\t\tprops: {\n\t\tmax: 1\n\t}\n})\ncy.get(valueSelector)\n\t.should('be.visible')\n\t.and('contain.text', '0')\n\t.get(buttonSelector)\n\t.click()\n\t.get(valueSelector)\n\t.should('contain.text', '1')`;
export const exampleCodeTestingLib = `const { getByText } = render(Stepper, {\n\t\tprops: {\n\t\tmax: 1\n\t}\n})\n\ngetByText('0') // Implicit assertion that "0" is within the component\n\nconst button = getByRole('button', { name: /increment/i })\n\n// Dispatch a click event to our increment button.\nawait fireEvent.click(button)\n\ngetByText('1')\n\nawait fireEvent.click(button)`;

export const highlights = ['file', 'CMS'];

<Tabs>
  <TabItem label="Vue Test Utils"> <Code code={exampleCodeVueTestUtils} lang="js" mark={highlights} /></TabItem>
  <TabItem label="Cypress"><Code code={exampleCodeCypress} lang="js" mark={highlights} /></TabItem>
  <TabItem label="Testing Library"><Code code={exampleCodeTestingLib} lang="js" mark={highlights} /></TabItem>
</Tabs>
